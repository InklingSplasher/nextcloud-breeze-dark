...
<div
    id="breezedark"
    class="breezedark-admin section"
    data-settings-url="<?php p($settingsUrl); ?>"
    data-custom-styling-url="<?php p($customStylingUrl); ?>"
...
>
    ...
    <button type="button" id="breezedark-theme-custom-styling-button"><?php p($l->t('Save')); ?></button>
</div>
